...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Control", altkey, "Control" }, "m",
        function ()
            os.execute(string.format("amixer -q set %s 100%%", beautiful.volume.channel))
            beautiful.volume.update()
        end),
    awful.key({ "Control", altkey, "Control" }, "0",
        function ()
    ...
    -- Lock Screen
    awful.key({ altkey, modkey }, "l", function () awful.spawn("slock") end),

    -- Suspend and lock
    awful.key({ altkey, modkey }, "s", function () awful.spawn("systemctl suspend && slock") end),
